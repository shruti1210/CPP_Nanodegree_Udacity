...
ChatBot& ChatBot::operator=(const ChatBot &source) // 3 : copy assignment operator
    {
        ...
        _chatLogic = source._chatLogic;
 		 _chatLogic->SetChatbotHandle(this);
  		//SetChatLogicHandle(*_chatLogic);
        // earlier error: Wrong *a = *p, that was the error causing the delete unique_ptr long error messages: 

https://knowledge.udacity.com/questions/162077
