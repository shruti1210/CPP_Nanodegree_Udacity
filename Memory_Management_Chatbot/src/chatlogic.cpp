...
ChatLogic::~ChatLogic()
{
  ...
  //  {
   ...
   // {
    ...
    //// not required to be used, since smart pointers are used
    //// EOF STUDENT CODE
}
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                          ...
                          //std::unique_ptr<GraphNode> &node  replacing the raw pointer GraphNode *node
                            ...
                            // create new edge std::make_unique<GraphEdge>(id) //
                          // std::unique_ptr<GraphEdge> edge = //declare the unique pointer
    ...
    // variable not a member; thus access method changes
